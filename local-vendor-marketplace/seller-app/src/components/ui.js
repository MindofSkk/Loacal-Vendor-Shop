  ...
  return (
    <Card style={{ gap: 12 }}>
      <View style={styles.row}>
        <View style={styles.thumb}>{image ? <Image source={{ uri: image }} style={styles.image} /> : <Text style={styles.thumbText}>P</Text>}</View>
        <View style={styles.flex}>
          <Text style={styles.title}>{product.name}</Text>
          <Text style={styles.muted}>₹{product.price}{product.stock != null ? ` | Stock ${product.stock}` : ''}</Text>
      ...
      <Card>
        <View style={styles.between}>
          <View style={styles.flex}>
            ...
            <Text style={styles.muted}>{order.customer?.name}</Text>
          </View>
...
export const styles = StyleSheet.create({
  ...
  option: { borderWidth: 1, borderColor: colors.border, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 9, backgroundColor: '#fff' },
